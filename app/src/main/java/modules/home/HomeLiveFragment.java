...
import modules.multitypeuse.items.extra.FootMoreItemViewProvider;
...
public class HomeLiveFragment extends HomeBaseFragment {
    ...
    protected void initView() {
        ...
        adapter.register(FootMoreItem.class,new FootMoreItemViewProvider());
